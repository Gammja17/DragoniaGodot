...
func _ready() -> void:
	...
	title.get_node("Center/Column/Create/Lines/Name").text = "시험용"
	title.get_node("Center/Column/Create/Lines/Accessory/Pick").select(6)
	title.get_node("Center/Column/Create/Lines/Start").pressed.emit()
	await _wait(1.5)
